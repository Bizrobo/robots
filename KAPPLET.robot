...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-types>
      <type name="テストKAPPLET"/>
    </referenced-types>
    <referenced-snippets/>
    <triggers/>
    <typed-variables>
      <typed-variable name="真偽判定" type-name="テストKAPPLET"/>
    </typed-variables>
    <global-variables/>
    <parameters>
      <parameter name="真偽判定" type-name="テストKAPPLET"/>
    </parameters>
    <return-variables>
      <variable name="真偽判定"/>
    </return-variables>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">真偽判定</property>
      <property name="parameter" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">テストKAPPLET</property>
        </property>
      </property>
    </object>
  </property>
